...
public class FigureDemo {
    public static void main(String[] args) {
        ...
        Triangle triangle2 = new Triangle("Треугольник 2", 1, 1, 1, 2);
        Triangle triangle3 = new Triangle("Треугольник 3", 7, 8, 9, 4);
    ...
    private static void sumOfPerimeters(Figure[] figures) {
        ...
        for (Figure figure : figures) {
            ...
            System.out.println("Периметр фигуры = " + (String.format("%.2f", perimeter)));
            sum += perimeter;
        }
